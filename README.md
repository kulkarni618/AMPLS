...
(Place a dramatic GIF or short video here showing a ship in very rough seas, emphasizing the violent motion and challenging environment. A helicopter hovering nearby would enhance the visual impact.)
...
(Place a high-quality screenshot or short video of your Unity simulation environment here. Show the USS Lassen and the helicopter model, perhaps with some visual debug overlays (e.g., force vectors, sensor rays) to highlight the simulation's technical detail and realism.)
