...
My audacious goal with AMPLS was to develop an autonomous simulation system that would land a helicopter itself with AI on moving ship and in Dynamic conditions, ensuring safe landings even when conditions render human physical intervention too risky. Although in Defence world even though how good ai is end descision is taken by a human, so this system ai + human together will give best results as this system is made to make landings way easier, like you have ai there to help pilot in that situation. Now ill be honest and say that there is still might be a "sim to real" problem that might occur as real data from sensors can make a huge difference in AI training. Although this research project made me learn a lot of things in RL,IL,DL and Deep Reinforcement Learning that i would like to share with you.
